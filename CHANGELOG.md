...
### Added
- `AGENTS.md` at the repo root and `.agents/skills/` folder with reusable agent skill files (`test`, `pr-workflow`, `add-analysis`) to provide a single source of truth for AI coding assistants (#85).
